...
- **Chunk size:** a sliding window over words, capped by a token check.
- **Overlap:** ~15% of the window, so a clause split across a boundary survives intact in at least one chunk.
